...
class WeatherDetails extends React.Component {
    ...
    render() {
        const { temp, city, temp_min, temp_max, description, icon , humidity, wind} = this.props
        ...
        return (
            <section className="weather-details">
                  ...
                  <div className="weather-details-more">
                     ...
                     <div className="weather-details-item">min: {tempRound(temp_min)}</div>
                     <div className="weather-details-item">max: {tempRound(temp_max)}</div>
